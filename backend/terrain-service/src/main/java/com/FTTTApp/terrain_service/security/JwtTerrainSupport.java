package com.FTTTApp.terrain_service.security;
...
public final class JwtTerrainSupport {

    private JwtTerrainSupport() {
    }
    ...
    public static boolean isClubManager(Jwt jwt) {
        return hasRole(jwt, "CLUB_MANAGER");
    }
