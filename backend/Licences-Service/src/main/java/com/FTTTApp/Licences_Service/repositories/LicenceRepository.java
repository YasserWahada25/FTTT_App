...
public interface LicenceRepository extends JpaRepository<Licence, Long> {
    ...
    Optional<Licence> findByLicenseNumber(String licenseNumber);

    boolean existsByPlayerIdAndStatusAndExpiryDateGreaterThanEqual(String playerId, LicenceStatus status, LocalDate date);
