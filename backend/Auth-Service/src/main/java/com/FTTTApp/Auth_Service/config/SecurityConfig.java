package com.FTTTApp.Auth_Service.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/auth/requests/**").hasRole("ADMIN_FEDERATION")
                        .requestMatchers("/api/auth/users/**").hasRole("ADMIN_FEDERATION")
